		    ...
		    <div class="container">
		        <div class="section-heading text-center animate " data-anim-type="zoomIn" data-anim-delay="600">
		            <h2 class="section-title "> 
		            	<span> <?php echo esc_html( get_theme_mod( 'dfmd_blog_title','Our Blogs') ); ?> </span> 
		            </h2>
		            <h4 class="section-description "><?php echo esc_html( get_theme_mod( 'dfmd_blog_desc', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.') ); ?></h4>
		        </div>
		            ...
		            <div class="col-md-6 cases-catipon tab-content">
		                ...
		                <div id="post_<?php echo get_the_ID(); ?>" class="tab-pane <?php if ( $count == '1' ) : echo 'active'; endif; ?> show">
		                    <div class="our_work-catipon-inner text-left">
		                        ...
		                        <a class="btn main-btn" href="<?php esc_url( the_permalink() ); ?>"><?php esc_html_e('Read More','dfmd'); ?></a>
		                    </div>
		                </div>
		                <?php 
		                    $count++; 
