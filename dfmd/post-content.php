<div class="blog-post-all row animate " data-anim-type="fadeInLeft" data-anim-delay="400">
    ...
    <div class="blog-post mb-5 <?php post_class(); ?>">
        ...
        <div class="blog-post-cnt">
            ...
            if ( get_post_type ( get_the_ID() ) == 'post' ) { 
            ?>
                <a class="btn main-btn mt-3 white px-5" href="<?php the_permalink(); ?>"><?php esc_html_e( 'View Article', 'dfmd' ); ?></a>
            <?php 
            } elseif ( get_post_type ( get_the_ID() ) == 'page' ) { ?>
                <a class="btn main-btn mt-3 white px-5" href="<?php the_permalink(); ?>"><?php esc_html_e( 'View Page', 'dfmd' ); ?></a>
            <?php 
            }
            ?>
        </div>
