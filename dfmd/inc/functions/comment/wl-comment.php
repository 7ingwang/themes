...
if ( ! function_exists( 'dfmd_comment' ) ) :
  	function dfmd_comment( $comment, $args, $depth ) {
		...
		<div class="media comment_box" id="comment-<?php comment_ID(); ?>">
            ...
            <div class="media-body">
                <div class="comment_detail">
                    ...
                    <div class="reply">
                        <a class="btn main-btn" href="#"> <?php esc_html_e( 'Like', 'dfmd' ); ?>  </a>
                    ...
                    <?php if ( $comment->comment_approved == '0' ) : ?>
			            <em class="comment-awaiting-moderation">
			            	<?php esc_html_e( 'Your comment is awaiting moderation.', 'dfmd' ); ?>		
			            </em>
			            <br/>
			        <?php endif; ?>
                </div>
